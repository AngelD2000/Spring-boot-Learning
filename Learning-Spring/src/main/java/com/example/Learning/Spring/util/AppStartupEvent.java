package com.example.Learning.Spring.util;
...
public class AppStartupEvent implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        List<GuestInformation> guestInformations = this.reservationService.getGuestInfos();
        guestInformations.forEach(System.out::println);
    }
}
